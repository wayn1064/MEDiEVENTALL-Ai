...
export const GNB: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const unsubCartAdd = mockPubSub.subscribe('EVENT_APPLIED', () => {
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0 flex flex-col justify-center cursor-pointer">
            <div className="text-2xl font-bold text-[var(--color-primary)] leading-none">
              MEDiEVENTALL<span className="text-[var(--color-secondary)]">-Ai</span>
            </div>
            <span className="text-[10px] text-gray-500 font-bold tracking-tight mt-1">세미나/학회/연수회/전시회 전문 플랫폼</span>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <button className="text-gray-600 hover:text-[var(--color-primary)] transition-colors relative flex flex-col items-center">
              ...
              <span className="text-[10px] mt-1 font-medium">신청내역</span>
            </button>
          </div>
        </div>
      </div>
